                    ...
                    <form name="Addform" method="post" encType="multipart/form-data" className="container was-validated" style={{ backgroundColor: "#bbbdbb", borderRadius: '10px', opacity: '0.85' }}><br />
                        ...
                        <div class="row">
                            ...
                            <div className="form-group col-md-6 mt-3 mt-md-0">
                                ...
                                <input name="orderid" type="text" className="form-control" id="orderid" placeholder="First Name" value={orderID} onChange={function (e) { setOrderID(e.target.value); }} readOnly />
                            </div><br />
                        ...
                        <div class="row">
                            ...
                            <div className="form-group col-md-6 mt-3 mt-md-0">
                                ...
                                <input name="text" type="text" className="form-control" id="email" placeholder="" value={status} onChange={function (e) { setStatus(e.target.value); }} readOnly />
                            </div><br />
